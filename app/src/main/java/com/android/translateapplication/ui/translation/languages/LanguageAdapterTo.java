...
public class LanguageAdapterTo extends RecyclerView.Adapter<LanguageAdapterTo.LanguageViewHolder> {
    ...
    public LanguageAdapterTo(List<LanguagesEntities> languages, OnLanguageClickListener listener) {
