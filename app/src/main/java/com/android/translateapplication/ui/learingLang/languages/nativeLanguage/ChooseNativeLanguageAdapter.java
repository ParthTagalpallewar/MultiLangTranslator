...
public class ChooseNativeLanguageAdapter extends RecyclerView.Adapter<ChooseNativeLanguageAdapter.LanguageViewHolder> {
    ...
    public ChooseNativeLanguageAdapter(List<LanguagesEntities> languages, OnLanguageClickListener listener) {
