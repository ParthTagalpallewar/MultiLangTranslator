...
public class LanguageAdapterFrom extends RecyclerView.Adapter<LanguageAdapterFrom.LanguageViewHolder> {
    ...
    public LanguageAdapterFrom(List<LanguagesEntities> languages, OnLanguageClickListener listener) {
