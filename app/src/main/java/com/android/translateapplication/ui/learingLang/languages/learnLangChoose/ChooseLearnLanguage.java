...
import com.android.translateapplication.ui.learingLang.languages.nativeLanguage.ChooseNativeLanguageAdapter;
...
public class ChooseLearnLanguage extends AppCompatActivity implements ChooseLearnLanguageAdapter.OnLanguageClickListener {

    private TranslationViewModel mViewModel;
    private RecyclerView mRecyclerView;
    private EditText mSearchView;
    private ChooseLearnLanguageAdapter mAdapter;
    ...
    private void setUpRecyclerView() {
        mViewModel.getAllLanguages().observe(this,lang -> {
            ...
            mAdapter = new ChooseLearnLanguageAdapter(lang,this::onClick);
    ...
    public void onClick(LanguagesEntities entities) {
        ...
        prefProvider.addLearningLanguage(entities.getCode());
        prefProvider.addLearningLanguageName(entities.getNativeName());
